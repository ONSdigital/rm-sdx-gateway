...
public class ReceiptEndpointUnitTest {
  ...
  private static final String BRES_RECEIPT_VALIDJSON = String.format("{\"caseRef\":  \"\", \"caseId\": \"%s\"}",
          CASE_ID);
  private static final String BRES_RECEIPT_VALIDJSON_NO_CASEREF = String.format("{\"caseId\": \"%s\"}",  CASE_ID);
  private static final String RECEIPT_VALIDJSON = String.format("{\"caseRef\":  \"%s\", \"caseId\": \"%s\"}", CASE_REF,
          CASE_ID);
