    ...
    stages {
        ...
        stage('test') {
            ...
            steps {
                ...
                sh 'sh artifactory-get.sh -r http://artifactory-sdc.onsdigital.uk/artifactory/libs-release-local/ -g uk.gov.ons.ctp.product -a sdxgatewaysvc > target/sdxgatewaysvc.jar'
                sh 'chmod 777 target/sdxgatewaysvc.jar'
                ...
                sh 'rm target/sdxgatewaysvc.jar'
            }
        }
    }
